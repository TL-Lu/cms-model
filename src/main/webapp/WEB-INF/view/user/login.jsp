			  ...
			  <div class="collapse navbar-collapse" id="navbarNavDropdown">
				    <ul class="navbar-nav">
					      <li class="nav-item active">
					        	<a class="nav-link" href="/user/toRegist.do">注册 <span class="sr-only">(current)</span></a>
					      </li>
					      <li class="nav-item">
		...
		<div class="jumbotron jumbotron-fluid">
			  <div class="container">
			    ...
			    <p class="lead">This is a modified jumbotron that occupies the entire horizontal space of its parent.</p>
			     	...
			     	<div class="content">
			    		 <form:form action="/user/login.do" class="form-inline"  method="post"  modelAttribute="user"  id="form" >
			    			<h4>Please Login：</h4>

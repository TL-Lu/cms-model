	...
	<ul class="list-group">
		...
		<li>
								    ...
								    <li class="page-item  ${page.isHasPreviousPage()==true?'':'disabled' }">
								     	 <a class="page-link" href="#" tabindex="-1"  onclick="page1(${page.getPageNum()-1})">Previous</a>
								    </li>
							    <c:if test="${page.getPageNum()-1!=0}">
							 	   	<li class="page-item"><a class="page-link" href="#" onclick="page1(${page.getPageNum()-1})">${page.getPageNum()-1}</a></li>
							    </c:if>
								    <li class="page-item active" aria-current="page">
								   	   <a class="page-link" href="#" onclick="page1(${page.getPageNum()})">${page.getPageNum()} <span class="sr-only">(current)</span></a>
								    </li>
								     <c:if test="${page.getPageNum()+1<=page.getPages()}">
								        		 <li class="page-item"><a class="page-link" href="#" onclick="page1(${page.getPageNum()+1})">${page.getPageNum()+1}</a></li>
							 		  </c:if>
								    <li class="page-item  ${page.isHasNextPage()==true?'':'disabled' }">
								      <a class="page-link" href="#" onclick="page1(${page.getPageNum()+1})">Next</a>
								    </li>
							  </ul>
